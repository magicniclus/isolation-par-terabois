...
const index = () => {
  return (
    <Basic
      ...
      title="Résultats de Simulation pour vos travaux d'isolation et de rénovation énergétique"
      metaDescription="Découvrez les résultats de votre simulation au travaux d'isolaiton. Obtenez des estimations claires et précises pour planifier votre projet d'isolation en toute confiance. Consultez vos résultats maintenant et avancez vers votre objectif."
    >
